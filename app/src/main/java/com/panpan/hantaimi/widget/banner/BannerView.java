package com.panpan.hantaimi.widget.banner;
...
import com.panpan.hantaimi.module.common.BrowserActivity;
import com.panpan.hantaimi.module.home.hanjuzong.NewsDetailActivity;
import com.panpan.hantaimi.utils.DisplayUtil;
...
public class BannerView extends RelativeLayout implements BannerAdapter.ViewPagerOnItemClickListener {
  ...
  LinearLayout points;
  @BindView(R.id.layout_banner_textview)
  TextView mtextView;
  ...
  public void build(List<BannerEntity> list) {
    ...
    viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
      ...
      public void onPageSelected(int pos) {
        pos = pos % pointSize;
        mtextView.setText(bannerList.get(pos).title);
        currentPos = pos;
  ...
  public void onItemClick() {
    String mlink=bannerList.get(currentPos).link;
    String type="";
    if(mlink.indexOf("hanjudongtai")!=-1)
      type="wen";
    else if(mlink.indexOf("hanjutupian")!=-1)
      type="tu";
    String mtitle= bannerList.get(currentPos).title;
    String ming=bannerList.get(currentPos).img;
    NewsDetailActivity.launch((Activity) getContext(),
            mtitle, mlink,ming,type
       );
  }
}
