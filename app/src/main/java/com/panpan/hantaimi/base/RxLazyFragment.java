package com.panpan.hantaimi.base;
...
public abstract class RxLazyFragment extends RxFragment {
    ...
    @LayoutRes
    int getLayoutResId();
    public static final String TAG = RxLazyFragment.class.getSimpleName();
    @Override
     ...
     * 加载数据
     */
    protected void loadData() throws UnsupportedEncodingException {
    }
    protected void loadData(String ss) {
    }
    /**
     * 显示进度条
     */
