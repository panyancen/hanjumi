...
import com.panpan.hantaimi.utils.ClipboardUtil;
import com.panpan.hantaimi.utils.ConstantUtil;
import com.panpan.hantaimi.utils.ToastUtil;
import com.panpan.hantaimi.widget.CircleProgressView;
...
public class BrowserActivity extends RxBaseActivity {
   /* @BindView(R.id.toolbar)
    ...
    public void initViews(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            url = "http://m.hanju.cc/"+intent.getStringExtra(ConstantUtil.EXTRA_URL);
